...
public class PythonDockerSandboxExample {
    ...
    public class SandboxRunner implements CommandLineRunner {
        ...
        private void runSimpleExample(PythonDockerExecutor executor) throws Exception {
            ...
            try {
                // 第一次执行时强制拉取镜像，确保环境正确
                PythonDockerExecutor.ExecutionResult result = executor.executePythonCode(
                        pythonCode, expectedOutput, executionCount, true);
        ...
        private void runWithArgsExample(PythonDockerExecutor executor) throws Exception {
            ...
            try {
                PythonDockerExecutor.ExecutionResult result = executor.executePythonCodeWithArgs(
                        pythonCode, testArgs, expectedOutput, executionCount, true);
        ...
        private void runWithTestFileExample(PythonDockerExecutor executor) throws Exception {
            ...
            try {
                PythonDockerExecutor.ExecutionResult result = executor.executePythonCodeWithTestFile(
                        pythonCode, testFileContent, expectedOutput, executionCount);
